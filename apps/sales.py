...
layout = html.Div([
    dbc.Row([
        dbc.Col(html.H3(children='Naturela Sales Forecast'), className="mb-2"),
        dbc.Col(dcc.RadioItems(
                id='xaxis-type',
                options=[{'label': i, 'value': i} for i in ['1M', '3M', '6M', '1Y']],
                value='Linear',
                labelStyle={'display': 'inline-block'}
            ), className="mb-4 text-center"),
        dbc.Col(html.H3(children='Otro Texto'), className="mb-2 text-right")
    ]),
    ...
    dbc.Row([
        dbc.Col([
            html.Br(),
            dbc.Row([
                dbc.Col(html.H5(children='Product'), width=4),
                dbc.Col(
                    dcc.Dropdown(
                        id='product_dd',
                        options=[
            ...
            html.Br(),
            dbc.Row([
                dbc.Col(html.H5(children='Customer'), width=4),
                dbc.Col(
                    dcc.Dropdown(
                        id='customer_dd',
                        options=[
            ...
            html.Br(),
            dbc.Row([
                dbc.Col(html.H5(children='Channel'), width=4),
                dbc.Col(
                    dcc.Dropdown(
                        id='channel_dd',
                        options=[
            ...
            html.Br(),
            dbc.Row([
                dbc.Col(html.H5(children='Sales Person'), width=4),
                dbc.Col(
                    dcc.Dropdown(
                        id='sales_person_dd',
                        options=[
            ...
            html.Br(),
            dbc.Row([
                dbc.Col(html.H5(children='City'), width=4),
                dbc.Col(
                    dcc.Dropdown(
                        id='city_dd',
                        options=[
        ...
        dbc.Col(dcc.Graph(id='line_cases_or_deaths'), width=7),
        dbc.Col(html.H5(children='una tabla'),width=2),
    ]),
